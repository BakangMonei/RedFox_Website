...
<html>
<head>
    <title>RedFox Booking Widget</title>
    <!-- for-mobile-apps -->
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Login form web template, Sign up Web Templates, Flat Web Templates, Login signup Responsive web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    <!-- //for-mobile-apps -->
...
<form action="Ticket.jsp">
    <div class="content">
        <h1>RedBox Movie Ticket Booking</h1>
        <div class="main">
        ...
        <p class="copy_rights">&copy; 2022 RedFox. All Rights Reserved | Design by Neiza_WaDi_Operation</a></p>
    </div>
